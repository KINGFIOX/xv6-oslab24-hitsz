...
static inline void w_mtvec(uint64 x) { __asm__ volatile("csrw mtvec, %0" : : "r"(x)); }
...
static inline void w_sscratch(uint64 x) { __asm__ volatile("csrw sscratch, %0" : : "r"(x)); }

static inline void w_mscratch(uint64 x) { __asm__ volatile("csrw mscratch, %0" : : "r"(x)); }
